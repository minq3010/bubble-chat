...
assert.equal(
  selectAsset([
    ...
    { name: "Bubble-Chat-1.0.2-linux-amd64.deb", browser_download_url: "https://github.com/deb" }
  ], "linux", "x64")?.name,
...
// Windows exe (x64)
assert.equal(
  selectAsset([{ name: "Bubble-Chat-1.0.2-win-x64.exe", browser_download_url: "https://github.com/w" }], "win32", "x64")?.name,
